...
def pred():
    ...
    city = request.form['city'] if request.method == 'POST' else 'Solapur'

    # API request to get weather data
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=a058defe8409917ea6bdf6a266a3aea8'
    ...
    API_KEY = 'AIzaSyDCLgl2rPggz7c5KiqR6aJylOOoZ2qwNFs'
    SEARCH_ENGINE_ID = '6727c5aa300994105'
...
# Twilio credentials
account_sid = 'ACe719a6c7c3fa7205b0b6b088e9e806f7'
auth_token = 'be64000fbd6ad987daf3efb66a893642'
client = Client(account_sid, auth_token)
twilio_phone_number = '+12516169019'
def send_report_message(message):
    # Send SMS
    client.messages.create(to="+918857855217", from_=twilio_phone_number, body=message)
